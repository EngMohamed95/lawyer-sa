...
export default function EditConsultantModal({ isOpen, onClose, onSuccess, consultantData }: EditConsultantModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const consultantRef = doc(db, "users", consultantData.id);
      ...
      <div className="bg-white rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-[#133B2E] text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold">تعديل بيانات المستشار</h2>
